...
public enum GameExceptionCode implements ExceptionCode {
    ...
    INVALID_GAME_ID(HttpStatus.BAD_REQUEST, "GAME-400-001", "유효하지 않은 고유 방 코드 입니다."),
    GAME_ID_EXHAUSTED(HttpStatus.SERVICE_UNAVAILABLE, "GAME-503-001", "사용 가능한 게임 코드가 모두 소진되었습니다. 서버 팀에 문의해주세요."),
